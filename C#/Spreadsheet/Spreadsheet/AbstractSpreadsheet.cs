...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        {
            // Returns the cells to recalculate, calling the actual get cells.
        ...
        /// 
        /// If a cell somehow ends up depending on itself then throw a circular exception.
        /// 
        /// Otherwise tag the cells as visited to ignore on further pass throughs.
        /// </summary>
